...
\caption[Visualisation of a synthetic forest patch used for
training]{\label{fig-lysva-plot-window-example}A piece of the Lysva
...
\caption[Visualisation of a basic orthophoto-based features (small
...
\caption[Visualisation of a basic orthophoto-based features (large
...
The transformations include scale and feature normalization – the coordinates are centered and normalized to the interval $(-1, 1)$ and the features are normalized to the interval $(-1, 1)$.j
...
\caption{\label{fig-height-dropout-aggressive}Same as
...
\caption{\label{fig-feature-ranges}Visualizations of how values of
