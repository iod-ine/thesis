...
\citet{wilkesTLS2treesScalableTree2023} introduce \textttt{TLS2trees}, another automated framework for segmentation of individual trees in terrestrial \gls{lidar} point clouds, consisting of a set of Python command line tools.
