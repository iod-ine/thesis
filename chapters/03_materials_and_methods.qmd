...
**Left**: DJI Matrice 600 Pro.
The same UAV model was used for the LiDAR survey.
**Right**: Geoscan 201 Geodesy.
The same UAV model was used for the orthophoto survey.
:::
