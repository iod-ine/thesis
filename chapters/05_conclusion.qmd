...
- more sophisticated height-dependent dropout, i.e. not on individual trees but for the whole patch, using vertical voxels slices as target to imitate effects of crown overlap and so on.
