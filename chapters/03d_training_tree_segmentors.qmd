...
Training was performed on a NVIDIA A100 GPU with 80G of memory.
...
Input transform and feature transform networks are not defined explicitly, but local networks that process features learn to perform a similar function.
