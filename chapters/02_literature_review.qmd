...
Its main goals are to provide the reader with context for the research described in the thesis and to highlight the research gap that the work tries to address.
...
[@lucasIdentificationLinearVegetation2019] uses the same set of eigenvalue-based features calculated for each point in a fixed-radius neighborhood, with other geometrical features including maximum local height difference and height standard deviation, local radius and local point density.
...
[@oscoConvolutionalNeuralNetwork2020]
