...
NASA provides free access to an abundance of satellite data through its [Earthdata platform](https://www.earthdata.nasa.gov/), Landsat mission with the Operation Land Imager (OLI) instrument and Terra mission with Moderate Resolution Imaging Spectroradiometer (MODIS) instrument being the most relevant for forest mapping applications.
